...
public class GameMultiActivity extends AppCompatActivity {
    ...
    public void newLetter(View view) {
        ...
        if (letter.length() == 1) {
            ...
            Toast.makeText(this, "Please Enter a Single Letter", Toast.LENGTH_SHORT);
        }
    }
    ...
    public void checkLetter(String letter) {
        ...
        for(int i=0; i<theWord.length(); i++) {
            ...
            if (theWord.charAt(i) == aLetter) {
                Log.d("MSYLOG", "Letter Found " + aLetter);
                letterGuessed = true;
                goodLetterCount++;
    ...
    public void wrongLetter(String badLetter) {
        ...
        //make a reference of the textview of wrong guessed letters in the activity layout
    ...
    public void showLetter(int position, char letterGuessed) {
        ...
        //make a reference to the LinearLayout in the activity_game XML using the R reference
        LinearLayout layout = (LinearLayout) findViewById(R.id.layoutLetters);
        ...
        //replace the "_" of the text view of the guessed letter in the textview
